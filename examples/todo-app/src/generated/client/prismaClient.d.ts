  ...
  */
      ...
      : S extends undefined
        ...
        : S extends { include: any } & (TodosArgs | TodosFindManyArgs)
          ...
          : S extends { select: any } & (TodosArgs | TodosFindManyArgs)
            ? {
                [P in TruthyKeys<S["select"]>]: P extends keyof Todos
                  ? Todos[P]
                  : never
              }
            : Todos
  ...
  > {
    ...
    > extends True
      ...
      : Prisma__TodosClient<TodosGetPayload<T> | null, null>
    ...
    aggregate<T extends TodosAggregateArgs>(
      args: Subset<T, TodosAggregateArgs>
    ): PrismaPromise<GetTodosAggregateType<T>>
    ...
    >(
      args: SubsetIntersection<T, TodosGroupByArgs, OrderByArg> & InputErrors
    ): {} extends InputErrors
   ...
   */
  export class Prisma__TodosClient<T, Null = never>
